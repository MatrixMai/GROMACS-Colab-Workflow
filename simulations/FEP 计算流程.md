### **【保姆级教程】在 Google Colab 上运行 KCNQ1 全四聚体 FEP 计算**

#### **核心设计思想 (Rationale)**

基于一个核心前提：**必须使用完整的 KCNQ1 四聚体模型**。其科学依据在于：
...
**说明:** 这是最后一步。我们用一个简短的 Python 脚本，从上一步生成的文本文件中提取 ΔG 数值，计算 ΔΔG，并给出清晰的结论。
